...
Antes de construir la aplicación, se realizó un proceso de limpieza de datos que incluyó:
	...
	•	Reemplazo de valores faltantes en variables categóicas con la categoría "unknown".
...
Puedes ver el dashboard desplegado aquí:

👉 https://my-repo-23tp.onrender.com

⸻

📚 Contexto académico

Este proyecto fue desarrollado como parte del Sprint 7 – Herramientas de Desarrollo de Software, dentro del proceso de formación como Data Analyst.
